...
tags:
- branch:idea/002-idea-70dedd18
- next:run a bounded 16-frame smoke on the existing teacher-anchor packet bundle that
  compares raw global-bank scoring against at least one hubness-calibrated scoring
  rule and optionally one hard-shortlist control, then inspect both retrieval metrics
  and anchor concentration statistics before deciding whether the packet interface
  is stable enough to widen.
- lineage:continue_line
- family:hubness-calibrated-packet-interface
---
...
- Ref: `idea-d3d22136`
- Branch: `idea/002-idea-d3d22136`
- Worktree: `/home/xinyizheng/vid_tokenizer/DeepScientist/quests/002/.ds/worktrees/idea-idea-d3d22136`
