...
type: ideas
kind: idea
title: Relation-Consistent Packet Alignment After Blueprint Downgrade
quest_id: '002'
scope: quest
...
tags:
- branch:idea/002-idea-253b77bd
- next:run one bounded relation-consistency repair package on the same frozen surface,
  then compare its predicted-to-target packet metrics directly against the downgraded
  blueprint result before widening scope.
- lineage:continue_line
- family:relation-consistent-packet-bridge
---
...
- Ref: `idea-c5e88710`
- Branch: `idea/002-idea-c5e88710`
- Worktree: `/home/xinyizheng/vid_tokenizer/DeepScientist/quests/002/.ds/worktrees/idea-idea-c5e88710`
