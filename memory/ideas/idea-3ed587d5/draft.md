---
id: idea-3ed587d5-draft
type: ideas
kind: idea_draft
title: From Machine-Oriented Video Compression to a Usable Downstream Pipeline Draft
...
- Foundation: `Idea `idea-9948c3dd` on `idea/002-idea-9948c3dd``
