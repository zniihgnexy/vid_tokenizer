...
tags:
- branch:idea/002-idea-e313b721
- next:hand off immediately to experiment for one bounded 16-frame smoke that compares
  raw global-bank scoring against querybank-normalized teacher-anchor scoring, dynamic
  inverted softmax if needed, and a csls-style control, then inspect both retrieval
  metrics and anchor concentration statistics before deciding whether single-bank
  normalization is enough.
- lineage:continue_line
- family:querybank-normalized-teacher-anchor-packet-interface
---
...
- Ref: `idea-70dedd18`
- Branch: `idea/002-idea-70dedd18`
- Worktree: `/home/xinyizheng/vid_tokenizer/DeepScientist/quests/002/.ds/worktrees/idea-idea-70dedd18`
